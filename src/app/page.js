...
export default function Homepage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between px-4 py-14 bg-emerald-900">
      <Image src="/logo-onboarding.png" width={ 500 } height={ 620 } />
      <h1 className="text-xl text-center text-green-50">Advent calendars are awesome
        <br />(and more sustainable 🌱)</h1>
      <Link
        href="/edit"
